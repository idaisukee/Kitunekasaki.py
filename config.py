...
define_keymap(None, {
    ...
    K("C-Win-equal"): K("C-Win-backslash"),
    ...
    K("Shift-C-Win-equal"): K("Shift-C-Win-backslash"),
    ...
    K("C-Win-Shift-key_6"): K("C-Win-equal"),
    ...
    K("C-Win-right_brace"): K("C-Win-Shift-minus"),
    K("C-Win-Shift-right_brace"): K("C-Win-Shift-semicolon"),
